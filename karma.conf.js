...
function getBuildPath(conf) {
    return conf.build_dir + conf.jsDest;
}

var aggregatorFileName = settings.bundleJS();
var buildPath = getBuildPath(settings);
console.log(buildPath, aggregatorFileName);
